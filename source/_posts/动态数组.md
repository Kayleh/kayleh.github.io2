...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328103402109.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/0200328103943700.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328104623565.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328105012778.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/2020032810554134.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328110106999.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328110807352.png)
...
![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328112238774.png)

- 在ArrayList中`增加一个记录首元素位置的属性`。
- 删除索引`0`位置的元素，我们只需要将`first`属性改为`1`。
- -在索引`0`位置添加元素，则只需要将`first`属性改为`0`。

![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200328112539197.png)

- 如果继续往前插入元素，则将插入的元素存放在索引`8`这个位置，并将`first`改为`8`。
- 当要获取索引`8`下一个元素时，对索引取`模`，则拿到索引`0`位置的元素。

![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/D:\Blog\source\_posts\【数据结构和算法】动态数组\20200328112630777.png)

- 如果插入元素，则可选择挪动`前半段`数据或`后半段`数据。
- 在索引`2`处插入元素`99`，可以选择将元素`22`，`33`左移，然后插入`99`即可。
- `扩容`和`缩容`同样可以优化。

![](https://cdn.jsdelivr.net/gh/kayleh/cdn/img/动态数组/20200413231142422.png)
